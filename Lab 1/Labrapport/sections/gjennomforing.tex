\section{Gjennomføring med måleresultater}
    ...
    \subsection{Måling på klippekrets med zenerdioder}
        ...
        I positiv halvperiode klippes spenningen til omtrent $5.8V$ istedenfor $-5.4V$, mens i negativ halvperiode klippes spenningen til omtrent $-7.5V$ istedenfor $7.5V$.
    ...
    \subsubsection{RC-ledd: $C2 = 10\mu F$}
        I figur \ref{fig:toveis_likeretting_transformator_RC3} er kondensatoren i RC-leddet byttet ut med en $10\mu F$ kondensator. 
        Kurven på oscilloskopet viser at spenningen over RC-leddet øker og synker raskere, og signalet får større variasjon, altså økt ripple.
        DC-spenningen i signalet måles til å være lik
        \begin{align*}
            V_{DC} = 11.44V
        \end{align*}
        med multimeteret.
